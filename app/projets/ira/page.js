        ...
        <div className="fixed inset-0 z-[100] bg-[#080f1e]/95 backdrop-blur flex flex-col">
            ...
            <div className="flex-1 relative overflow-hidden">
                ...
                {documents.length > 1 && index > 0 && (
                    <button onClick={() => setIndex(i => i - 1)} className="absolute left-4 top-1/2 -translate-y-1/2 rounded-full bg-[#080f1e]/80 backdrop-blur p-3 hover:bg-[#1F3E71] transition"><ChevronLeft className="h-6 w-6 text-[#EDF0FC]" /></button>
                )}
                {documents.length > 1 && index < documents.length - 1 && (
                    <button onClick={() => setIndex(i => i + 1)} className="absolute right-4 top-1/2 -translate-y-1/2 rounded-full bg-[#080f1e]/80 backdrop-blur p-3 hover:bg-[#1F3E71] transition"><ChevronRight className="h-6 w-6 text-[#EDF0FC]" /></button>
                )}
            </div>
                ...
                <div className="mx-auto max-w-7xl px-6 py-10 flex gap-10 items-start">
                    ...
                    <main className="flex-1 min-w-0 flex flex-col gap-16">
                        ...
                        <section id="roles" className="scroll-mt-24">
                            ...
                            <motion.div variants={fadeUp} initial="initial" whileInView="animate" viewport={{ once: true }} className="rounded-3xl border border-[#C3D0F6]/10 bg-[#1F3E71]/20 p-7 mb-6">
                                <div className="flex items-center gap-3 mb-5">
                                    <div className="rounded-xl bg-[#4782E4]/15 p-2.5"><Users className="h-5 w-5 text-[#4782E4]" /></div>
                                    <div>
                                        <p className="text-xs text-[#8BA8EE] uppercase tracking-widest">{ui.mainRoleLabel}</p>
                                        <h3 className="font-semibold text-[#EDF0FC]">{p.mainRole.title}</h3>
                                    </div>
                                </div>
