...
const PROJECT = {
    ...
    mainRole: {
        ...
        items: [
            "Établir un contrat de communication définissant les règles de fonctionnement de l'équipe dès le lancement du projet.",
            "Mettre en place et gérer le backlog de l'équipe via Notion et Figma.",
            "Animer les réunions hebdomadaires d'équipe chaque mercredi, en présentiel.",
            "Gérer le scope et prendre des décisions de coupure de contenu en fonction des contraintes de temps.",
                ...
                <div className="mx-auto max-w-7xl px-6 py-10 flex gap-10 items-start">
                    ...
                    <main className="flex-1 min-w-0 flex flex-col gap-16">
                        ...
                        <div className="flex flex-wrap justify-between items-center gap-4 pt-4">
                            <Link href="/projets/ira" className="inline-flex items-center gap-2 rounded-xl border border-[#C3D0F6]/20 px-5 py-2.5 text-sm hover:bg-[#1F3E71]/35 transition"><ChevronLeft className="h-4 w-4" /> Projet précédent : IRA</Link>
                            <Link href="/projets/figure-out" className="inline-flex items-center gap-2 rounded-xl bg-white text-[#0D1F3E] px-5 py-2.5 font-medium hover:bg-[#EDF0FC] transition text-sm">Projet suivant : Figure Out →</Link>
                        </div>
                    </main>
                </div>
